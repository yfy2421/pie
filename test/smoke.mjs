...
const requiredSrc = [
  ...
  "dashboard/session-restore.ts", "dashboard/session-activation.ts", "dashboard/dashboard-sessions.ts", "dashboard/dashboard-settings.ts", "dashboard/dashboard-menus.ts",

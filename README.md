<p align="center">
  <img src="https://img.shields.io/badge/tests-1007%20%E2%9C%93-34D399?style=flat&labelColor=1a1a2e" alt="Tests">
...
```bash
npm test            # 全量 1007 项测试（unit + routes + frontend）
...
| 套件 | 数量 | 覆盖 |
|------|------|------|
| unit | 650 | Shell/权限安全、工具、状态存储、偏好 facade、MCP、搜索替换、Agent memory |
...
test/                    # 58 个测试文件，1007 项（含 CSS / build smoke / packaged E2E）
scripts/                 # 编译/构建/清理脚本
```

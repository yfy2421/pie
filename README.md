<p align="center">
  <img src="https://img.shields.io/badge/tests-1064%20%E2%9C%93-34D399?style=flat&labelColor=1a1a2e" alt="Tests">
...
```bash
npm test            # 全量 1064 项测试（unit + routes + frontend）
...
| 套件 | 数量 | 覆盖 |
|------|------|------|
| unit | 667 | Shell/权限安全（含 workspace 级规则、外部删除确认）、工具、状态存储、偏好 facade、MCP、搜索替换、Agent memory |

...
export const MCP_CATALOG: CatalogEntry[] = [
  ...
  { id: "sqlite", name: "SQLite", description: "SQLite 数据库查询和管理", category: "数据库", command: "npx", args: ["-y", "mcp-server-sqlite", "/path/to/db.sqlite"], postInstallHint: "替换为你的数据库文件路径" },
  { id: "duckduckgo", name: "DuckDuckGo 搜索", description: "互联网搜索，无需 API Key，国内可访问", category: "网络", command: "npx", args: ["-y", "duckduckgo-mcp-server"] },
  ...
  { id: "docker", name: "Docker", description: "Docker 容器、镜像、日志管理", category: "工具", command: "npx", args: ["-y", "mcp-server-docker"] },
